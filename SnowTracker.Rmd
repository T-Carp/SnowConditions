...
board_register_github(repo = "T-Carp/SnowConditions", token = "f7d52ac0f9ea58f1d2bab52dcc29104e49b9dfeb")

obs <- pin_get("obs", board = "github")
...
pin(obs, description = "Historical Weather Observations", board = "github")
```
